...
LOG_FILE="$LOG_DIR/vd_vbmetad_$(date +"%Y-%m-%d_%H-%M-%S").log"
...
module_status_update() {
    ...
    [ -z "$desc_active" ] && DESCRIPTION="[$desc_vbmeta, $desc_avb, $desc_ts_sp, $desc_crypto] A Magisk module to disguise the props of vbmeta, security patch date and encryption status."
